/**
  ...
  */
metadata {
	definition (name: "CW2 Dimmer Switch", namespace: "astrobass", author: "Astro Bass", ocfDeviceType: "oic.d.light", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
  ...
  simulator {
    ...
    input "step", "enum", title: "Step", description: "Step (1-99)", required: false, options:["low": "Low", "high": "High"], defaultValue: "low"
    input "delay", "enum", title: "Delay", description: "Delay (0-255)", required: false, options:["low": "Low", "high": "High"], defaultValue: "low"
  }
